...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
    <input type="text" name="name" maxlength="15" placeholder="Ваше имя" pattern="[A-zА-я]{1,15}[ ]?[A-zА-я]{1,15}" title="Вводите только буквы!" value="<?php echo $mess[1];?>"/>
    <span class="err">*<?php if(!$mess[0]) echo "Заполните поле!";?></span><br/>
    <input type="text" name="email" placeholder="Адрес вашей электронной почты" value="<?php echo $mess[3];?>"/>
...
function showData($mess){
    if(($mess[0]=="true")&&($mess[2]=="true")&&($mess[4]=="true")){
        ...
        echo "<br/> Адрес вашей электронной почты: ".$mess[3];
